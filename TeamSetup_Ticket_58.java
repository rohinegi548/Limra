...
public class TeamSetup_Ticket_58 {
	...
	@Test //Check the popup is displayed correctly
	public void CanUserAbleToRejectTheChanceCard() throws InterruptedException, AWTException{
		...
		driver.findElement(By.xpath("//*[contains(@class,'applyBtn gc1')]")).click(); Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[contains(@class,'modalFooter')]/button[2]")).click(); Thread.sleep(2000);
		
		driver.findElement(By.xpath("/html/body/div[2]/div/div/div[1]/button")).click(); Thread.sleep(2000);
		
		Assert.assertEquals(driver.findElement(By.xpath("//*[contains(@class,'offerChanceCard')]")).getText(),"WOULD YOU LIKE TO PLAY A CHANCE CARD?");
		
		System.out.println("User can reject the chance card, Popup is closed, Would You Like to Play a Chance Card page is displaying\n:Passing Test!");
		
	}
	
	
	@Test //Check user can confirm the chance card
	public void CanUserAbleToAcceptTheChanceCard() throws InterruptedException, AWTException{
		...
		driver.findElement(By.xpath("//*[contains(@class,'modalFooter')]/button[1]")).click(); Thread.sleep(2000);
		
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(@class,'totalManagerHours')]")).isDisplayed(),"User can not confirm the chance card:\nFailing Test!");
		
		System.out.println("User can confirm the chance card, And the Chance Card is applied\n:Passing Test!");
