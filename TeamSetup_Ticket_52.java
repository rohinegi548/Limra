...
public class TeamSetup_Ticket_52 {
	...
	@Test //Check Decision Input tab is active
	public void IsDecisionInputTabActive() throws InterruptedException, AWTException{
		...
		driver.findElement(By.xpath("//div[contains(@class,'modalFooter')]/button[contains(text(),'YES')]")).click(); Thread.sleep(2000);
		
		System.out.println("Chance card has been applied.");
		
		teamBtn.click();
		System.out.println("Clicked on Team button in left again to check, No option to select Chance card again");
		
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(text(),'DECISION INPUT')]")).getAttribute("class").contains("active") 
				&& driver.findElement(By.xpath("//button[contains(text(),'RECRUITMENT & SELECTION')]")).isDisplayed(), 
				"Decision Input page is not displaying and tab is inactive:\n Failing Test!");
		
				System.out.println("Decision Input page is displayed and tab is active\n:Passing Test!");
