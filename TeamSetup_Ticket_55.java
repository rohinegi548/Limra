...
public class TeamSetup_Ticket_55 {
	...
	@Test //Check the user can accept the chance card
	public void IsUserCanAcceptChanceCard() throws InterruptedException, AWTException{
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(text(),'Chance Card events')]")).isDisplayed(), 
				"On accepting Yes, Chance Card events Pop-up is not displaying:\n Failing Test!");
		
				System.out.println("On accepting Yes, Chance Card events Pop-up is displaying\n:Passing Test!");
