...
public class TeamSetup_Ticket_53 {
	...
	@Test //Check chance card is offered
	public void IsChanceCardOffered() throws InterruptedException, AWTException{
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(text(),'chance card?')]")).isDisplayed() 
				...
				"Chance Card Yes/No page is not displaying:\n Failing Test!");
		
				System.out.println("Chance Card Yes/No page is displaying\n:Passing Test!");
