...
public class TeamSetup_Ticket_56 {
	...
	public void IsChanceCardPopupDisplayedCorrectly() throws InterruptedException, AWTException{
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(text(),'Chance Card events')]")).isDisplayed(), 
				"CHANCE CARD Popup is not displaying\n:Failing Test!");
		
				System.out.println("CHANCE CARD Popup has been opened and displaying correctly\n:Passing Test!");
