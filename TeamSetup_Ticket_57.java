...
public class TeamSetup_Ticket_57 {
	...
	@Test //Close the Chance Card Events popup & And the Would You Like to Play a Chance Card page is displayed
	public void IsWouldYouLikeToPlayChanceCardDisplayed() throws InterruptedException, AWTException{
		...
		Assert.assertEquals(driver.findElement(By.xpath("//*[contains(@class,'offerChanceCard')]")).getText(),"WOULD YOU LIKE TO PLAY A CHANCE CARD?");
				...
				System.out.println("Popup is closed, Would You Like to Play a Chance Card page is displaying\n:Passing Test!");
