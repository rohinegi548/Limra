...
public class TeamSetup_Ticket_54 {
	...
	@Test //Check the user can decline the chance card
	public void IsUserCanDeclineChanceCard() throws InterruptedException, AWTException{
		...
		Assert.assertTrue(driver.findElements(By.xpath("//*[contains(text(),'Chance Card events')]")).size()<1, 
				"On accepting No, Chance Card events Pop-up is displaying:\n Failing Test!");
		
				System.out.println("On accepting No, No Chance Card events Pop-up is displaying\n:Passing Test!");
