...
public class TeamSetup_Ticket_50 {
	...
	@Test //Check the message displays on D&D tab
	public void IsSelectTeamMessageDisplayOnDDTab() throws InterruptedException, AWTException{
		...
		Assert.assertEquals(driver.findElement(By.xpath("//*[contains(@class, 'instruction')]")).getText(), "Select team to input decisions", 
				"Select team message doesn't match\n:Failing Test!");
		
				System.out.println("Select team message matches\n:Passing Test!");
