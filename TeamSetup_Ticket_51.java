...
public class TeamSetup_Ticket_51 {
	...
	public void IsDecisionInputTabActive() throws InterruptedException, AWTException{
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(text(),'DECISION INPUT')]")).getAttribute("class").contains("active"), "Decision Input tab is not active:\n Failing Test!");
		
				System.out.println("D&D sub-navigation menu has been loaded & Decision Input tab is active\n:Passing Test!");
