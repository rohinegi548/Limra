...
public class TeamSetup_Ticket_86 {
	...
	@Test(priority=1) //Check Next button will display the next tab in the Decisions & Data page
	public void IsNextButtonBehavesProperlyInDDTab() throws InterruptedException, AWTException{
		...
		//finding team setup button
				...
				Assert.assertTrue(driver.findElement(By.xpath("//*[contains(@class,'financeTab') and contains(text(),'TRAINING & DEVELOPMENT')]")).isEnabled() && 
						          driver.getCurrentUrl().equals("http://leo-limra-controlpanel.limra.leo-development.leocnames.com/yearone/decisions/input/2"), 
						
						          "When click Next in R&S breadcrumb Then the Training & development page is not displaying, Failing Test!");
				
						System.out.println("When click Next in R&S breadcrumb Then the Training & development page is displayed, Passing Test!");
	}
